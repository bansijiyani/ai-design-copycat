    ...
    return (
      <div className="min-h-screen bg-background">
        ...
        <div className="grid place-items-center py-32">
          ...
          <Link to="/products" className="mt-4 text-gold hover:underline">Back to shop</Link>
        </div>
        <Footer />
      </div>
    );
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 py-4 text-sm text-muted-foreground">
        <Link to="/" className="hover:text-gold">Home</Link> / <Link to="/products" className="hover:text-gold">Products</Link> / <Link to="/products" search={{ category: product.category }} className="hover:text-gold capitalize">{product.category}</Link> / <span className="text-foreground">{product.name}</span>
      </div>
