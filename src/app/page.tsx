    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="container mx-auto px-4 py-16 lg:py-24 grid lg:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <div className="mt-10 flex flex-wrap gap-4">
            ...
            <Link href={{ pathname: "/products", query: { category: "dresses" } }} className="px-8 py-3.5 bg-maroon text-white font-semibold tracking-wider text-sm hover:bg-maroon/90 transition">
              SHOP WESTERN
            </Link>
          </div>
          <div className="mt-12 pt-8 border-t border-border grid grid-cols-3 gap-6">
            {[
              { v: "1K+", l: "Happy Customers" },
      ...
      <section className="container mx-auto px-4 py-16">
        <div className="flex items-end justify-between mb-10">
          ...
          <Link href="/products" className="text-gold text-sm font-medium flex items-center gap-2 hover:gap-3 transition-all">
        ...
        <div className="text-center mt-12">
          <Link href="/products" className="inline-flex items-center gap-2 px-8 py-3.5 border-2 border-gold text-gold font-semibold tracking-wider text-sm hover:bg-gold hover:text-white transition">
      ...
      <section className="bg-muted/40 py-20 mt-10">
        <div className="container mx-auto px-4">
          <div className="flex items-end justify-between mb-10">
            ...
            <Link href="/products" className="text-maroon text-sm font-medium flex items-center gap-2 hover:gap-3 transition-all">
